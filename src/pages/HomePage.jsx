  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col-reverse md:flex-row items-start gap-10">
        <AnimatedSection className="flex-1">
          ...
          <div className="flex gap-4 mb-5">
            <a
              ...
              className="w-11 h-11 flex items-center justify-center rounded-full bg-primary text-white hover:bg-primary-dark hover:-translate-y-1 transition-all duration-200"
              aria-label="GitHub"
            >
        ...
        <AnimatedSection className="flex-shrink-0 md:pt-2" delay={200}>
          <img
            src={`${basePath}images/cwe.jpeg`}
            alt="Gabriel Kiveu"
            className="w-52 h-52 md:w-64 md:h-64 rounded-2xl object-cover border-2 border-border ring-4 ring-primary/20 shadow-2xl"
          />
        </AnimatedSection>
      </div>
